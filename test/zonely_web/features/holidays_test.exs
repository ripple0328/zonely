defmodule ZonelyWeb.Features.HolidaysTest do
  ...
  describe "Holidays - Filtering and Selection" do
    setup do
      ...
      # Same country
      create_test_user(%{id: 8, name: "User B", country: "US"})
  ...
  describe "Holidays - Team Impact Analysis" do
    ...
    feature "shows impact when team members are on holiday", %{session: session} do
      ...
      # US users for US holiday
      |> assert_text("2 team members affected")
      # UK user still working
      |> assert_text("Coverage: 1 available")
    end
    ...
    feature "highlights holidays affecting multiple team members", %{session: session} do
      ...
      |> visit("/holidays")
      |> wait_for_liveview()
      # CSS class for high impact holidays
      |> assert_has(css(".holiday-high-impact"))
  ...
  describe "Holidays - Cross-Cultural Awareness" do
    ...
    # TODO: Depends on country naming; adjust to codes or map display layer
    @tag :skip
  ...
  describe "Holidays - Data Loading and Performance" do
    ...
    # TODO: Decide UX for unknown country display; update assertion accordingly
    @tag :skip
    feature "handles missing holiday data gracefully", %{session: session} do
      ...
      # Invalid country
      create_test_user(%{id: 23, name: "Edge Case", country: "XX"})
  ...
  describe "Holidays - Accessibility and Mobile" do
    # TODO: Add role=main or adjust test to existing semantics
    @tag :skip
