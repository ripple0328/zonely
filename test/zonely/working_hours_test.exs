defmodule Zonely.WorkingHoursTest do
  ...
  describe "get_statistics/1" do
    setup do
      users = [
        %User{id: 1, timezone: "America/New_York", work_start: ~T[09:00:00], work_end: ~T[17:00:00]},
        %User{id: 2, timezone: "America/New_York", work_start: ~T[10:00:00], work_end: ~T[18:00:00]},
  ...
  describe "time_ranges_overlap?/4" do
    test "detects overlapping ranges" do
      assert WorkingHours.time_ranges_overlap?(~T[09:00:00], ~T[17:00:00], ~T[14:00:00], ~T[22:00:00]) == true
      assert WorkingHours.time_ranges_overlap?(~T[09:00:00], ~T[12:00:00], ~T[10:00:00], ~T[15:00:00]) == true
    end
    
    test "detects non-overlapping ranges" do
      assert WorkingHours.time_ranges_overlap?(~T[09:00:00], ~T[17:00:00], ~T[18:00:00], ~T[22:00:00]) == false
      assert WorkingHours.time_ranges_overlap?(~T[14:00:00], ~T[16:00:00], ~T[09:00:00], ~T[12:00:00]) == false
    end
    
    test "handles edge cases" do
      # Touching ranges don't overlap
      assert WorkingHours.time_ranges_overlap?(~T[09:00:00], ~T[12:00:00], ~T[12:00:00], ~T[15:00:00]) == false
      # Same range overlaps
      assert WorkingHours.time_ranges_overlap?(~T[09:00:00], ~T[17:00:00], ~T[09:00:00], ~T[17:00:00]) == true
    end
  end
